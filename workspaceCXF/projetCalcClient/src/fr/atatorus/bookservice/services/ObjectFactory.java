...
public class ObjectFactory {
    ...
    private final static QName _Test_QNAME = new QName("http://services.bookservice.atatorus.fr/", "test");
    private final static QName _TestResponse_QNAME = new QName("http://services.bookservice.atatorus.fr/", "testResponse");
     ...
     * 
     */
    @XmlElementDecl(namespace = "http://services.bookservice.atatorus.fr/", name = "test")
     ...
     * 
     */
    @XmlElementDecl(namespace = "http://services.bookservice.atatorus.fr/", name = "testResponse")
