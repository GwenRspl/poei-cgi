 ...
 * 
 */
@WebServiceClient(name = "ServiceHelloService", targetNamespace = "http://projetSoapServerClient/", wsdlLocation = "http://127.0.0.1:8586/HelloWSGwen?WSDL")
    ...
    extends Service
{
    ...
    private final static QName SERVICEHELLOSERVICE_QNAME = new QName("http://projetSoapServerClient/", "ServiceHelloService");

    static {
        URL url = null;
        WebServiceException e = null;
        try {
            url = new URL("http://127.0.0.1:8586/HelloWSGwen?WSDL");
     ...
     *     returns HelloWSGwen
     */
    @WebEndpoint(name = "HelloWSGwenPort")
    public HelloWSGwen getHelloWSGwenPort() {
        return super.getPort(new QName("http://projetSoapServerClient/", "HelloWSGwenPort"), HelloWSGwen.class);
    }
     ...
     */
    @WebEndpoint(name = "HelloWSGwenPort")
    public HelloWSGwen getHelloWSGwenPort(WebServiceFeature... features) {
        return super.getPort(new QName("http://projetSoapServerClient/", "HelloWSGwenPort"), HelloWSGwen.class, features);
    }
