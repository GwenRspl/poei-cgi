 ...
 * 
 */
@WebServiceClient(name = "ServiceHelloService", targetNamespace = "http://prjSOAPServer/", wsdlLocation = "http://127.0.0.1:8586/HelloWSGwen?WSDL")
    ...
    extends Service
{
    ...
    public HelloWSGwen getHelloWSGwenPort() {
        return super.getPort(new QName("http://prjSOAPServer/", "HelloWSGwenPort"), HelloWSGwen.class);
    }
    ...
    public HelloWSGwen getHelloWSGwenPort(WebServiceFeature... features) {
        return super.getPort(new QName("http://prjSOAPServer/", "HelloWSGwenPort"), HelloWSGwen.class, features);
    }
